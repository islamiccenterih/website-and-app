...
$router->get('/daily-quran', [PublicSite\FaithPagesController::class, 'dailyQuran']);
$router->get('/daily-duas', [PublicSite\FaithPagesController::class, 'dailyDuas']);
$router->get('/99-allah-names', [PublicSite\FaithPagesController::class, 'allahNames']);
$router->get('/quran-reader', [PublicSite\FaithPagesController::class, 'quranReader']);
$router->get('/family-shares', [PublicSite\FaithPagesController::class, 'familyShares']);
$router->get('/janazah-steps', [PublicSite\FaithPagesController::class, 'janazah']);
$router->get('/hajj-umrah', [PublicSite\FaithPagesController::class, 'hajjUmrah']);
$router->get('/daily-tasbeeh', [PublicSite\FaithPagesController::class, 'tasbeeh']);
$router->get('/api/faith/daily', [PublicSite\FaithPagesController::class, 'dailyApi']);
...
$router->post('/admin/faith-content/{key}', [Admin\FaithContentController::class, 'update'], ['admin']);
